...
2.  A concise summary.
3.  A list of feedback items, each with 'area', 'issue', 'suggestion', optional 'bestPracticeReference', optional 'bestPracticeReasoning', and 'severity' ('Critical', 'Major', 'Minor', 'Info').
